...
// main script
void runsw(int mu, int delta, string seq_a, string seq_b, string qual_a, string qual_b, int N_max, string &ca, string &cb, string &qa, string &qb, int &starta, int &startb, int &olen){
