...
### trend of reactive clones from post-tx stim in post-tx unstim samples
	pdf(paste(prefix, "frequency.pdf", sep = "_"), width=20, height=10)
	par(mfrow=c(2,4))
...
## panel 1, freq tracking for donor reactive clones from pre-tx MLR
	...
	scatterTracking(newData, logscale = logscale, title = "Pre-tx MLR donor reactive clones\n")
...
scatterTracking <- function(data, title = "", logscale = T){
