...
open(Fout, ">/ifs/scratch/c2b2/ys_lab/bg2178/projects/tcr/Sims/dat/trimmed/$coreName.trimed.fastq");
#open(Fout2, ">/ifs/scratch/c2b2/ys_lab/bg2178/projects/tcr/Sims/dat/trimmed/$coreName.removedReads.txt");
my $wSize = 5;
my $cutoffM = 15;
my $indx=0;
...
while(<mF>){
	...
	print Fout "$readID\tremoved\n";
	print Fout "N\tremoved\n";
	print Fout "+\tremoved\n";
	print Fout "#\tremoved\n";
     }	  
}
